...
imgCinza = cv.GaussianBlur(imgCinza,(9,9),0)

# 
########################################################################
# Reduzindo os Detalhes
########################################################################
#
imgCinza = cv.morphologyEx(imgCinza, cv.MORPH_OPEN, kernel)
imgCinza = cv.morphologyEx(imgCinza, cv.MORPH_CLOSE, kernel)
