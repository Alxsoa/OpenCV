...
# 
########################################################################
# Usando o Método de Drago para Obter Imagens Coloridas de 24 bits
########################################################################
#
...
ldrDrago = cv.resize(ldrDrago, (450, 300), interpolation = cv.INTER_AREA)
ldrDrago = cv.copyMakeBorder (
                                src=ldrDrago, 
                                top=5, 
                                bottom=5, 
                                left=5, 
...
cv.imshow ( "Efeito Final", ldrDrago)
cv.waitKey(0)
