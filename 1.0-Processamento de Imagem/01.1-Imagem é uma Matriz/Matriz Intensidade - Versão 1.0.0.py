...
plt.title( "Transição das Imagens (Primeira Mudança)", fontsize=20, weight='bold' )
plt.axis ( "off" )
...
Grafico = plt.figure(figsize=(15,8))
plt.title( "Transição das Imagens (Segunda Mudança)", fontsize=20, weight='bold' )
plt.axis ( "off" )
...
Grafico = plt.figure(figsize=(15,8))
plt.title( "Transição das Imagens (Terceira Mudança)", fontsize=20, weight='bold' )
plt.axis ( "off" )
...
Grafico = plt.figure(figsize=(15,8))
plt.title( "Transição das Imagens (Quarta Mudança)", fontsize=20, weight='bold' )
plt.axis ( "off" )
