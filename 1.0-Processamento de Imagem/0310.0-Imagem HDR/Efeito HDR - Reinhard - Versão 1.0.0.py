...
# 
########################################################################
# Usando o Método de Reinhard para Obter Imagens Coloridas de 24 bits
########################################################################
#
...
ldrReinhard = cv.resize(ldrReinhard, (450, 300), interpolation = cv.INTER_AREA)
ldrReinhard = cv.copyMakeBorder (
                                src=ldrReinhard, 
                                top=5, 
                                bottom=5, 
                                left=5, 
...
cv.imshow ( "Efeito Final", ldrReinhard)
cv.waitKey(0)
