...
VideoMapaCalor = "/VideoMapaCalor.avi"
...
for iAux in range(0, TamanhoVideo):
    ...
    if Interacao == 1:
        ...
        cv2.imwrite(CaminhoVideo+'Frame.jpg', VideoFrame)
        cv2.imwrite(CaminhoVideo+'/DifrencaBackgroudFrame.jpg', Filtro)
        ...
        cv2.imwrite(CaminhoVideo+'/Mascara.jpg', ImagemAcumulada)
